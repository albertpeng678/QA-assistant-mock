...
JUDGMENT_FULL_TEXT = (
    ...
    "三、本院之判斷：按個人資料保護法第12條，非公務機關違反本法規定，致個人資料被竊取、洩漏或其他侵害者，應查明後以適當方式通知當事人。"
    "被告於知悉外洩事故後逾二月始以網站公告為之，未個別通知當事人，難認已盡即時且適當之通知義務，違反通知義務明確。"
    "又被告就資料庫之安全維護顯有疏失，與原告個資外洩具相當因果關係。\n"
    "四、損害賠償之範圍：原告就實際財產損害未能舉證，惟其精神上所受痛苦，審酌兩造身分、經濟狀況及侵害情節，認以新臺幣伍萬元為適當。\n"
    "五、綜上所述，原告依個資法第29條請求被告賠償，為有理由，應予准許。訴訟費用之負擔，依民事訴訟法第78條，由敗訴之被告負擔。\n\n"
    "中華民國113年6月26日\n"
    "民事第三庭　法官　○○○\n"
    "以上正本係照原本作成。"
)
